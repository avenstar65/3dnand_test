...
static u32 q3n_reg_read(struct q3n *q3n, u32 reg)
{
#ifdef Q3N_HOST_TEST
...
static void q3n_reg_write(struct q3n *q3n, u32 reg, u32 value)
{
#ifdef Q3N_HOST_TEST
...
static int q3n_hw_wait_ready(struct q3n *q3n)
{
	...
	for (attempt = 0; attempt < 1000; attempt++) {
		u32 status = q3n_reg_read(q3n, Q3N_REG_STATUS);
...
static void q3n_hw_set_page_addr(struct q3n *q3n, u32 page)
{
	...
	q3n_reg_write(q3n, Q3N_REG_ADDR_LO, (u32)address);
	q3n_reg_write(q3n, Q3N_REG_ADDR_HI, (u32)(address >> 32));
}

static void q3n_hw_read_window(struct q3n *q3n, u8 *buffer, size_t length)
{
	size_t offset;
...
static void q3n_hw_write_window(struct q3n *q3n, const u8 *buffer,
				size_t length)
{
	size_t offset;
	...
	for (offset = 0; offset < length; offset += sizeof(u32)) {
		...
		q3n_reg_write(q3n, Q3N_REG_DATA, value);
	}
}
...
int q3n_hw_reset(struct q3n *q3n)
{
	...
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_RESET);
...
int q3n_hw_read_id(struct q3n *q3n, u8 *id, size_t len)
{
	...
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_READ_ID);
...
int q3n_hw_read_oob(struct q3n *q3n, u32 page, void *oob)
{
	...
	q3n_reg_write(q3n, Q3N_REG_OOB_LEN, Q3N_LOGICAL_OOB_SIZE);
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_READ_PAGE_OOB);
	ret = q3n_hw_wait_ready(q3n);
	if (ret)
		return ret;
		     ...
		     bool raw, struct q3n_ecc_result *result)
{
	...
	q3n_hw_set_page_addr(q3n, page);
	q3n_reg_write(q3n, Q3N_REG_READ_FLAGS, raw ? Q3N_READ_F_RAW : 0);
	q3n_reg_write(q3n, Q3N_REG_LEN, Q3N_PAGE_SIZE);
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_READ_PAGE);
	ret = q3n_hw_wait_ready(q3n);
	if (ret)
		return ret;
	...
	if (!raw && result) {
		result->status = q3n_reg_read(q3n, Q3N_REG_ECC_STATUS);
		result->max_bitflips =
			q3n_reg_read(q3n, Q3N_REG_ECC_MAX_BITFLIPS);
		result->corrected_bits =
			q3n_reg_read(q3n, Q3N_REG_ECC_CORRECTED_BITS);
		result->failed_step =
			q3n_reg_read(q3n, Q3N_REG_ECC_FAILED_STEP);
	}
...
int q3n_hw_program_oob(struct q3n *q3n, u32 page, const void *oob)
{
	...
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_PROGRAM_PAGE_OOB);
	return q3n_hw_wait_ready(q3n);
}
			...
			const void *data, const void *oob)
{
	...
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_PROGRAM_PAGE);
	ret = q3n_hw_wait_ready(q3n);
	if (ret || !oob)
		return ret;
...
int q3n_hw_erase_block(struct q3n *q3n, u32 block)
{
	...
	q3n_reg_write(q3n, Q3N_REG_LEN, Q3N_ERASE_SIZE);
	q3n_reg_write(q3n, Q3N_REG_CMD, Q3N_CMD_ERASE_BLOCK);
	return q3n_hw_wait_ready(q3n);
}
...
int q3n_hw_set_retry_mode(struct q3n *q3n, unsigned int mode)
{
	...
	q3n_reg_write(q3n, Q3N_REG_RETRY_MODE, mode);
	q3n->retry_mode = mode;
	return 0;
}
