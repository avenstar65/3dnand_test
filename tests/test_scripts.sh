...
assert_contains README.md 'OOB 只保留坏块标记'
assert_contains qemu/README.md 'same-die RAID1 mirror pairs'
assert_contains qemu/README.md 'no RAID manifest is stored in OOB'
assert_contains qemu/README.md 'only logical OOB byte exposed to NAND core'
