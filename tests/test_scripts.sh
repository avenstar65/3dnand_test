...
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'debugfs_create_dir'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'qemu_3dnand_append_parity_locked'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'qemu_3dnand_recover_page_locked'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'qemu_3dnand_invalidate_group_parity'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'struct qemu_3dnand_data_block_meta'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'data_block_generation\[Q3N_RAID_LANES\]'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'qemu_3dnand_parity_generation_valid'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'generation_updates'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'inject_data_loss'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'Q3N_FAULT_INJECT_DATA_LOSS'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'raid_recovered'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'debugfs_create_file.*raid_failed'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'parity_stale'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'parity_sequence'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand.c 'faults_injected'
