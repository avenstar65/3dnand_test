...
assert_contains README.md 'Multi-plane Page RAID1 / RAID5'
assert_contains README.md 'manifest 从 byte 1 开始'
assert_contains qemu/README.md 'same-die RAID1 mirror pairs'
assert_contains qemu/README.md 'logical OOB bytes 1\.\.127'
...
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand_main.c 'mtd->oobsize = 0'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand_main.c 'mtd->_read = qemu_3dnand_profile_read'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand_main.c 'mtd->_write = qemu_3dnand_profile_write'
...
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand_main.c 'mtd->_sync = qemu_3dnand_profile_sync'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand_main.c 'mtd->_block_isbad = qemu_3dnand_profile_isbad'
assert_contains linux/drivers/mtd/nand/raw/qemu_3dnand_main.c 'mtd->_block_markbad = qemu_3dnand_profile_markbad'
...
sed -n '/Q3N_MEDIA_LAYOUT_HELPERS_BEGIN/,/Q3N_MEDIA_LAYOUT_HELPERS_END/p' \
  ...
  "$controller_tmp/q3n-media-layout-helpers.inc"
