...
- [x] **Step 1: Record the pre-refactor verification baseline**
...
- [x] **Step 2: Write tests for the source parser using literal C fixtures**
...
- [x] **Step 4: Implement the minimal comment-aware function scanner**
...
- [x] **Step 5: Add architecture assertions without enabling the final file list yet**
...
- [x] **Step 6: Run focused and shell regression tests**
...
- [x] **Step 3: Move shared structs and constants into the internal header**
...
- [x] **Step 4: Move and rename hardware helpers**
...
- [x] **Step 5: Wire build and overlay copying**
...
- [x] **Step 6: Run focused regression tests and both compile modes**
...
- [x] **Step 1: Write failing KUnit device-match tests**
...
- [x] **Step 2: Write a failing QEMU READID test**
...
- [x] **Step 4: Implement the private descriptor table**
...
- [x] **Step 5: Replace Linux's synthetic READID**
...
- [x] **Step 6: Correct QEMU's READID bytes**
...
- [x] **Step 7: Wire the device object into driver and KUnit builds**
...
- [x] **Step 8: Run GREEN and integration tests**
...
- [x] **Step 1: Add failing ownership and size tests**
...
- [x] **Step 3: Move mapping/buffer preparation and write orchestration**
...
- [x] **Step 4: Split the long read recovery function**
...
- [x] **Step 5: Move profile OOB, erase, and block operations**
...
- [x] **Step 3: Move simple serial mapping and metadata helpers**
...
- [x] **Step 4: Decompose the parity worker into named phases**
...
- [x] **Step 5: Preserve lifecycle boundaries**
...
- [x] **Step 6: Run GREEN in both modes**
...
- [x] **Step 1: Add failing NAND ownership tests**
...
- [x] **Step 3: Move OOB layout and ECC callbacks**
...
- [x] **Step 4: Move legacy command and status callbacks**
...
- [x] **Step 5: Move attach, scan, BBT, and MTD registration**
...
- [x] **Step 6: Verify callback gating after preprocessing and compilation**
...
- [x] **Step 7: Run KUnit and MTD smoke tests**
...
- [x] **Step 1: Add failing debugfs/main ownership tests**
...
- [x] **Step 3: Move debugfs in functional groups**
...
- [x] **Step 4: Decompose probe without changing order**
...
- [x] **Step 5: Decompose remove into explicit reverse lifecycle calls**
...
- [x] **Step 6: Enable the final architecture and function-size file list**
...
- [x] **Step 1: Update user-facing architecture and device documentation**
...
- [x] **Step 2: Run all static and host tests**
...
- [x] **Step 3: Rebuild QEMU and mode 0 Linux**
...
- [x] **Step 4: Rebuild mode 1 Linux and rootfs**
...
- [x] **Step 5: Run all multi-plane acceptance tests**
...
- [x] **Step 6: Compare runtime geometry and interfaces with the recorded baseline**
...
- [x] **Step 7: Mark plan and design verification results**
...
- [x] **Step 8: Commit final documentation and verification metadata**
...
- [x] **Step 9: Review and push only after verification**
